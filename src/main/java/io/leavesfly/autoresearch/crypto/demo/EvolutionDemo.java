...
import io.leavesfly.autoresearch.crypto.evolution.AtlasEvolutionEngine;
 ...
 * <p>使用方式：
 * <pre>
 *   mvn compile exec:java -Dexec.mainClass="demo.io.leavesfly.autoresearch.crypto.EvolutionDemo"
 * </pre>
 */
